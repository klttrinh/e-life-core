...
export default {
  ...
  coveragePathIgnorePatterns: ['/node_modules/', '/tests/', '/dist/', '/jest/'],
  ...
  globalSetup: '<rootDir>/node_modules/@e-life/shared-libraries/dist/src/jest/setup.jest.js',

  // A path to a module which exports an async function that is triggered once after all test suites
  globalTeardown: '<rootDir>/node_modules/@e-life/shared-libraries/dist/src/jest/teardown.jest.js',
  ...
  setupFiles: ['<rootDir>/node_modules/@e-life/shared-libraries/dist/src/jest/env.jest.js'],

  // A list of paths to modules that run some code to configure or set up the testing framework before each test
  setupFilesAfterEnv: ['<rootDir>/node_modules/@e-life/shared-libraries/dist/src/jest/lifecycles.jest.js'],
