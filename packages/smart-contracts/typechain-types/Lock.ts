...
export interface LockInterface extends utils.Interface {
  ...
  events: {
    "LogMessage(uint256)": EventFragment;
...
export type LogMessageEvent = TypedEvent<[BigNumber], LogMessageEventObject>;
...
export interface Lock extends BaseContract {
  ...
  filters: {
    "LogMessage(uint256)"(_unlockTime?: null): LogMessageEventFilter;
    LogMessage(_unlockTime?: null): LogMessageEventFilter;
